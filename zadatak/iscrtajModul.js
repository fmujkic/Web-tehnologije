...
Operacije,dodajAktivnost(okvir,'WT','vježbe',12,15,'Ponedjeljak');
Operacije.dodajAktivnost(okvir,'WT','predavanje',9,12,'Ponedjeljak');
Operacije.dodajAktivnost(okvir,'OOI','vježbe',12,15,'Utorak');